...
// add a "hug" to a compliment and see my hug count go up accordingly

// add an event listener to the hug buttons
// we will do this in our event listeners callback
...
// i want to add my own compliments

// find my form tag
const formTag = document.querySelector('#compliment-form');
// add an event listener to when i sumbit my form (click on the submit button)
formTag.addEventListener('submit', function(event) {
  event.preventDefault();

  const newComplimentText = event.target.querySelector('input').value;
  console.log(newComplimentText)
  // create a new li with the compliment i inputed into my form and add to my ul
  ulTag.innerHTML =
  `<li>
      <div class="trash">🗑</div>
      <img width="200" src="https://placekitten.com/${randomNumber(400, 500)}/${randomNumber(200, 250)}" />
      <h3>"${newComplimentText}"</h3>
      <div>
        <cite data-hug-count="0">Hugged 0 times</cite>
        <button>🤗 it</button>
      </div>
