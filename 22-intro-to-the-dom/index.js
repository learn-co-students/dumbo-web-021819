...
// find the <em> tag that I hate
let emTag = document.querySelector('em');
// remove it from the DOM
emTag.remove()


// first we find the place we want to add them to the DOM
// queryselect something
let ulTag = document.querySelector('ul')

// want to loop through all of the compliments
for (let i=0; i < compliments.length; i++) {
  let complimentText = compliments[i];

  // adds the created li to our ul
  ulTag.innerHTML +=
  `<li>
...
// display each compliment (start with console.log) we want to make each compliment into:
    // Turn this:
// "Your eyebrows are on fleek."
    // Into this:
...
// we need to add our new <li>s into the DOM
